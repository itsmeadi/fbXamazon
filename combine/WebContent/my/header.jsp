...
<body onload="load()" class="home-page home page-template page-template-page-templates page-template-full-width page-template-page-templatesfull-width-php page page-id-26 front-page-template wpb-js-composer js-comp-ver-5.0.1 vc_responsive no-js">

<div id="friends"></div>
<jsp:include page="header-only.jsp"></jsp:include>